...
//Faz a leitura do arquivo e inicializa a CPU=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    ...
    int c3_num, c3_aux, c3_resula;//Variaveis do codigo 3
...
//Reconhece as instrucoes=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    ...
    do{
        ...
        //LDA-------------------------------------------------------------------
            case 0x10101001:
                ...
                switch (variavel){
                    case 0x00000000:
                        CPU.reg.A=0;
                        printf("A=%i.\n\t;carrega 0 no acumulador(A)\n", CPU.reg.A);
                        break;
                    case 0x00000001:
                        CPU.reg.A=1;
                        printf("A=%i.\n\t;carrega 1 no acumulador(A)\n", CPU.reg.A);
                        break;
                    case 0x00000101:
                        CPU.reg.A=5;
                        printf("A=%i.\n\t;carrega 5 no acumulador(A)\n", CPU.reg.A);
                        break;
                    case 0x00001011:
                        CPU.reg.A=11;
                        printf("A=%i.\n\t;carrega 11 no acumulador(A)\n", CPU.reg.A);
                        break;
                    case 0x00001110:
                        CPU.reg.A=14;
                        printf("A=%i.\n\t;carrega 14 no acumulador(A)\n", CPU.reg.A);
                        break;
                }//switch variavel
            ...
            case 0x10100101:
                ...
                switch (variavel){
                    case 0x01010100:
                        CPU.reg.A=c2_resul1;
                        printf("A=%i(%s).\n\t;carrega o valor de RESUL1 no acumulador(A)\n", CPU.reg.A, RESUL1);
                        break;
                    case 0x01010101:
                        CPU.reg.A=c2_resul2;
                        printf("A=%i(%s).\n\t;carrega o valor de RESUL2 no acumulador(A)\n", CPU.reg.A, RESUL2);
                        break;
                    case 0x01010111:
                        CPU.reg.A=c3_aux;
                        printf("A=%i(%s).\n\t;carrega o valor de AUX no acumulador(A)\n", CPU.reg.A, AUX);
                        break;
                    case 0x01011000:
                        CPU.reg.A=c3_resula;
                        printf("A=%i(%s).\n\t;carrega o valor de RESULA no acumulador(A)\n", CPU.reg.A, RESULA);
                        break;
                }//switch variavel
        ...
        //LDX-------------------------------------------------------------------
            case 0x10100010:
                ...
                switch (variavel){
                    case 0x00000001:
                        CPU.reg.X=1;
                        printf("X=%i.\n\t;carrega 1 em X, que sera usado como contador\n", CPU.reg.X);
                        break;
                    case 0x00001000:
                        CPU.reg.X=8;
                        printf("X=%i.\n\t;carrega 8 em X, que sera usado como contador\n", CPU.reg.X);
                        break;
                }//switch variavel
        ...
        //LDY-------------------------------------------------------------------
            case 0x10100000:
                ...
                switch (variavel){
                    case 0x00000000:
                        CPU.reg.Y=0;
                        printf("Y=%i.\n\t;carrega 0 em Y, que sera usado como contador\n", CPU.reg.Y);
                        break;
                }//switch variavel
        ...
        //STA-------------------------------------------------------------------
            case 0x10000101:
                ...
                switch (variavel){
                    case 0x01010000:
                        c1_resul=CPU.reg.A;
                        printf("%s=%i.\n\t;guarda o valor de A em RESUL\n", RESUL, c1_resul);
                        break;
                    case 0x01010001:
                        c2_n1=CPU.reg.A;
                        printf("%s=%i.\n\t;guarda o valor de A em N1\n", N1, c2_n1);
                        break;
                    case 0x01010010:
                        c2_n2=CPU.reg.A;
                        printf("%s=%i.\n\t;guarda o valor de A em N2\n", N2, c2_n2);
                        break;
                    case 0x01010011:
                        c2_temp=CPU.reg.A;
                    ...
                    case 0x01010100:
                        c2_resul1=CPU.reg.A;
                        printf("%s=%i.\n\t;guarda o valor de A em RESUL1\n", RESUL1, c2_resul1);
                        break;
                    case 0x01010101:
                        c2_resul2=CPU.reg.A;
                        printf("%s=%i.\n\t;guarda o valor de A em RESUL2\n", RESUL2, c2_resul2);
                        break;
                    case 0x01010110:
                        c3_num=CPU.reg.A;
                        printf("%s=%i.\n\t;guarda o valor de A em NUM\n", NUM, c3_num);
                        break;
                    case 0x01010111:
                        c3_aux=CPU.reg.A;
                        printf("%s=%i.\n\t;guarda o valor de A em AUX\n", AUX, c3_aux);
                        break;
                    case 0x01011000:
                        c3_resula=CPU.reg.A;
                        printf("%s=%i.\n\t;guarda o valor de A em RESULA\n", RESULA, c3_resula);
                        break;
                }//switch variavel
            ...
            case 0x01101001:
                ...
                switch (variavel){
                    case 0x00001010:
                        ...
                        printf("A=A+10 -> A=%i.\n\t;adiciona 10 ao valor de A(A=A+10)\n", CPU.reg.A);
                        break;
                }//switch variavel
            ...
            case 0x01100101:
                ...
                switch (variavel){
                    case 0x01010001:
                        ...
                        printf("A=A+%i(%s) -> A=%i.\n\t;adiciona N1 ao valor de A(A=A+N1)\n", CPU.reg.A, N1, c2_n1);
                        break;
                    case 0x01010011:
                        CPU.reg.A=CPU.reg.A+c2_temp;
                        printf("A=A+%i(%s) -> A=%i.\n\t;adiciona TEMP ao valor de A(A=A+TEMP)\n", CPU.reg.A, c2_temp, TEMP);
                        break;
                    case 0x01011000:
                        CPU.reg.A=CPU.reg.A+c3_resula;
                        printf("A=A+%i(%s) -> A=%i.\n\t;adiciona RESULA ao valor de A(A=A+RESULA)\n", c3_resula, RESULA, CPU.reg.A);
                        break;
                }//switch variavel
            ...
            case 0x11101001:
                ...
                switch (variavel){
                    case 0x00000011:
                        ...
                        printf("A=A-3 -> A=%i.\n\t;subtrai o valor em A por 3 (A=A-3)\n", CPU.reg.A);
                        break;
                }//switch variavel
            ...
            case 0x00100110:
                ...
                switch (variavel){
                    case 0x01010011:
                        ...
                        printf("%s=%i\n\t;roda os bits e carrega o bit de C\n", TEMP, c2_temp);
                        break;
                }//switch variavel
        ...
        //ASL-------------------------------------------------------------------
            case 0x00000110:
                ...
                switch (variavel){
                    case 0x01010001:
                        c2_n1=c2_n1*2;
                        printf("%s=%i.\n\t;faz o shift de N1 pra esquerda e manda o bit que seria\n\t\t;'perdido' para C\n", N1, c2_n1);
                        break;
                }//switch variavel
            ...
            case 0x11010000:
                ...
                switch (variavel){
                    case 0x00001100:
                        if(CPU.flags.Z==0){
                            CPU.reg.PC--;
                            printf("Branch realizado - [PC]%i->%i.\n\t;volta pro MUL se a flag zero(Z)=0, Z vai ser setado pra 1 quando\n\t\t;o DEX resultar em X=0\n", CPU.reg.PC, 9);
                            CPU.reg.PC=9;
                            IC=18;
                        }else{
                            printf("Branch nao realizado.\n\t;volta pro MUL se a flag zero(Z)=0, Z vai ser setado pra 1 quando\n\t\t;o DEX resultar em X=0\n");
            ...
            case 0x10010000:
                ...
                switch (variavel){
                    case 0x00001000:
                        if(CPU.flags.C==0){
                            CPU.reg.PC--;
                            printf("Branch realizado - [PC]%i->%i.\n\t;compara se C e igual a 0, se for faz o pulo\n", CPU.reg.PC, 18);
                            CPU.reg.PC=18;
                            IC=35;
                        }else{
                            printf("Branch nao realizado.\n\t;compara se C e igual a 0, se for faz o pulo\n");
        ...
        //CLC-------------------------------------------------------------------
            case 0x00011000:
                CPU.flags.C=0;
                printf("\tCLC(%08X): C=%i.\n\t;limpa a flag carry pra nao interferir na conta\n", opcode, CPU.flags.C);
                break;
        //BRK-------------------------------------------------------------------
            case 0x00000000:
                printf("\tBRK(%08X).\n\t;encerra o programa\n", opcode);
